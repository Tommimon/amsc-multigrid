...
void jacobi_mpi(std::vector<std::vector<double>>& grid,
    ...
    std::vector<std::vector<double>> temp(local_nx, std::vector<double>(local_ny));

    // Perform Jacobi iteration on each point in the local block
